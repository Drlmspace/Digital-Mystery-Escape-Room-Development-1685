      ...
      >
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {playerNames.map((name, index) => (
                    <span key={index} className="px-3 py-1 bg-mystery-700 text-mystery-200 rounded-full text-sm">
                      {name}
                    </span>
                  ))}
                </div>
        ...
        >
          ...
          <div className="prose prose-lg max-w-none text-mystery-100 narrative-text">
            <p className="mb-4">
              Through your meticulous investigation, you've uncovered the truth behind Dr. Eleanor Blackwood's 
              disappearance. The forgery ring operating within the Metropolitan Museum of Digital Arts has been 
              exposed, and the corrupt board members have been brought to justice.
            </p>
            
            <p className="mb-4">
              Dr. Blackwood's dedication to preserving the integrity of art and culture has been vindicated. 
              The real artworks have been recovered, and the museum can now rebuild its reputation on a 
