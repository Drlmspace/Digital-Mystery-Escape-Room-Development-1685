  ...
  const renderPuzzleComponent = () => {
    ...
    switch (puzzle.type) {
      case 'pattern-recognition':
        return <PatternRecognitionPuzzle {...commonProps} />;
      case 'audio-analysis':
        return <AudioAnalysisPuzzle {...commonProps} />;
      case 'text-analysis':
        return <TextAnalysisPuzzle {...commonProps} />;
      case 'data-analysis':
        return <TextAnalysisPuzzle {...commonProps} />;
