                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          ...
                          <div className={`text-xs px-2 py-1 rounded-full mt-1 ${
                            team.game_state === 'playing' ? 'bg-green-600 text-white' :
                            team.game_state === 'paused' ? 'bg-yellow-600 text-white' :
            ...
            <div className="glass-effect rounded-2xl p-6">
                          ...
                          <div className="space-y-2">
                            <div className="flex gap-2">
                              <input
                                ...
                                placeholder="Enter audio message URL (e.g., https://example.com/audio.mp3)"
              ...
              <div className="mt-8 flex justify-center">
                <button
                  ...
                  className="px-8 py-3 gold-gradient text-mystery-900 font-semibold rounded-lg hover:opacity-90 transition-opacity"
                >
                  Save Audio Messages to Database
                </button>
              </div>
            </div>
          </motion.div>
